...
import com.euprava.zdravstvo.client.OtvoreniPodaciNedostupanException;
...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(OtvoreniPodaciNedostupanException.class)
    public ResponseEntity<Map<String, Object>> opNedostupan(OtvoreniPodaciNedostupanException ex) {
